...
class SENet3D(nn.Module):
    ...
    def __init__(self, block, layers, shortcut_type='B', cardinality=32, num_classes=2):
        ...
        self.layer2 = self._make_layer(block, 128, layers[1], shortcut_type, cardinality, stride=(2, 2, 2))
        self.layer3 = self._make_layer(block, 256, layers[2], shortcut_type, cardinality, stride=(2, 2, 2))
