...
class IGReg(nn.Module):
    ...
    """
    def __init__(self, n_classes=2, num_channels=32, dim_proj=64, nc_pos=3, nc_neg=3, m=0.5, distance='cos'):
    ...
    def cosine(self, input1, input2):
        cos_sim = nn.functional.cosine_similarity(input1.unsqueeze(0), input2.unsqueeze(0), dim=1)
...
if __name__ == "__main__":
    ...
    model = IGReg(n_classes=2, num_channels=32, dim_proj=64, nc_pos=6, nc_neg=6, m=0.5).cuda()
